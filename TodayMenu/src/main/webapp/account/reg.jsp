...
<body>
	<form action="RegAccountC" onsubmit="return validCheck2()"
		...
		<table id="regTable" border="1">
			...
			<tr>
				...
				<td class="regTd2"><input name="name" id="name"
					placeholder="2글자이상 5글자 미만"></td>
			</tr>
			<tr>
				<td class="regTd1">ID</td>
				<td class="regTd2"><input name="id" id="id"
					placeholder="영어 소문자 + 숫자"></td>
			</tr>
			<tr>
				<td class="regTd1">PW</td>
				<td class="regTd2"><input name="pw" id="pw" type="password"
					placeholder="영어 대,소문자,숫자,특문 ! @"></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="regTd2"><input name="answer"></td>
			</tr>
